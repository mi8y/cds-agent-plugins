...
| 🚧     | [`@mi8y/cds-langchain-vectorstore`](./packages/cds-langchain-vectorstore/) |                                                                                                                                                                                                                                                                                                    | Vector Store                | RAG, Semantic Search, Embeddings Storage, Retrieval                                                                       |
| 🚧     | [`@mi8y/cds-langchain-telemetry`](./packages/cds-langchain-telemetry/)     |                                                                                                                                                                                                                                                                                                    | Telemetry                   | Observability, Auditing, Monitoring                                                                                       |
